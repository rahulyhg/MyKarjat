...
//                    Log.d("chatact",fb.getChattime());
                    ...
                    Intent nfact=new Intent();
                    nfact.setClass(ChatActivity.this,ChatActivity.class);
                    PendingIntent home= PendingIntent.getActivity(ChatActivity.this,0,nfact,0);



                    NotificationCompat.Builder nBuilder=new NotificationCompat.Builder((getApplicationContext()));
                    nBuilder.setSmallIcon(R.mipmap.ic_launcher);
                    nBuilder.setContentTitle("KarjatOnline");
                    nBuilder.setContentText(fb.getChatmsg());
